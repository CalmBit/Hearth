...
void createAndInitializeWindow(SDL_Window **window, SDL_Renderer **renderer)
{
	...
	*window = SDL_CreateWindow("Hello World!", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, FORTITUDE_WINDOW_COLUMNS*8, FORTITUDE_WINDOW_ROWS*12, SDL_WINDOW_RESIZABLE);
